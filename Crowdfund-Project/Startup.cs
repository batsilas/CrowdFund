...
namespace Crowdfund_Project
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<CrowFundDbContext>(options =>
            options.UseSqlServer(
                Configuration.GetConnectionString("DefaultConnection")));
            services.AddIdentity<IdentityUser, IdentityRole>().AddDefaultTokenProviders()
            .AddEntityFrameworkStores<CrowFundDbContext>();
            ...
            services.AddScoped<IUserBackerService, UserBackerService>();
